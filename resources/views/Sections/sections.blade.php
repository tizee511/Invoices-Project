                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50' style="text-align: center">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0p">اسم القسم</th>
                                <th class="border-bottom-0">الوصــف</th>
                ...
                <div class="modal-body">
                    <form action="{{ route('sections.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control" id="section_name" name="section_name" value="{{ old('section_name') }}">
                        </div>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel3">تعديل القسم</h5>
