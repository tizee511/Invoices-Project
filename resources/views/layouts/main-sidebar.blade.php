            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/img/faces/1705160948680.JPG') }}"><span
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_unpaid')) }}">الفواتير
                                    الغيرمدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_Partial')) }}">الفواتير المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan
