                    ...
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">
                                {{ \App\Models\invoices::count('total') }}
                            </p>
                        </div>
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">
                                {{\App\Models\invoices::where('value_status', 2)->count('total') }}
                            </p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">
                                {{\App\Models\invoices::where('value_status', 1)->count('total') }}
                            </p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-up text-white"></i>
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">
                                {{\App\Models\invoices::where('value_status', 3)->count('total') }}
                            </p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class="fas fa-arrow-circle-down text-white"></i>
